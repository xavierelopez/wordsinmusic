...
module.exports = (function() {
	return {	
		//Eventually this API Handler will connect to a safer API. 
		...
		removeSymbolsAndContractions: function(string) {
		...
		extractWords: function(options, callback) {
			...
			wordCounts = _(wordsArray).chain()
						.map(function(word) {
							...
							cleanWord = that.removeSymbolsAndContractions(cleanWord);
